...
Note: web addresses should start with `https://` most of the time. When we enter
`google.com` in our browser, the browser adds it for us and goes to the 
resulting address `https://google.com`.

<div className="grid grid-cols-[minmax(0,_0.5fr),repeat(3,_minmax(0,_1fr)),minmax(0,_0.5fr)] my-6 border border-gray-300 rounded-lg p-6">
