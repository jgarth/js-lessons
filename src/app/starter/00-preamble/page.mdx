...
<div className="bg-green-500/50 border-green-500 border rounded-lg p-4 mb-4">
  **While it's going to be difficult, you are here because we think you can do
  it!**
</div>
...
<Task title="Write down why you are here" className="my-6">
    ...
    Write it down somewhere you can look at it again. When times are tough and you’re thinking of quitting, look at what you wrote down.
